...
<body>
	...
	<div class="content" style="width: auto">
        ...
        <form action="xl_them.php" method="post" style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <h1 class="text-center py-3">Thêm Sản Phẩm</h1>
        <div style="margin-bottom: 15px;">
            <label for="masp" style="font-weight: bold;">Mã Sản Phẩm <span style="color: red;">(Bắt buộc)</span>:</label>
            <input type="text" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="masp" name="masp" required>
        </div>
        <div style="margin-bottom: 15px;">
            <label for="tensp" style="font-weight: bold;">Tên Sản Phẩm <span style="color: red;">(Bắt buộc)</span>:</label>
            <input type="text" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="tensp" name="tensp" required>
        </div>
        <div style="margin-bottom: 15px;">
            <label for="maloai" style="font-weight: bold;">Loại Sản Phẩm:</label>
            <select style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="maloai" name="maloai">
                <?php foreach ($loai_sanpham as $loai) : ?>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <span>S: </span><input type="number" value="0" min="0" max="100" style="width: 15%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="size1" name="size1">
			<span> M: </span><input type="number" value="0" min="0" max="100" style="width: 15%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="size2" name="size2">
			<span> L: </span><input type="number" value="0" min="0" max="100" style="width: 15%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="size3" name="size3">
			<span> XL: </span><input type="number" value="0" min="0" max="100" style="width: 15%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="size4" name="size4">
        </div>
        <div style="margin-bottom: 15px;">
            <label for="giaban" style="font-weight: bold;">Giá Bán:</label>
            <input type="text" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="giaban" name="giaban">
        </div>
        <div style="margin-bottom: 15px;">
            <label for="trangthai" style="font-weight: bold;">Trạng Thái:</label>
            <input type="text" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="trangthai" name="trangthai">
        </div>
        <div style="margin-bottom: 15px;">
            <label for="anh" style="font-weight: bold;">Hình Ảnh Sản Phẩm (Tùy Chọn):</label>
            <input type="text" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="anh" name="anh">
        </div>
		<div style="margin-bottom: 15px;">
            <label for="anh" style="font-weight: bold;">List Hình Ảnh (Tùy Chọn):</label>
            <input type="text" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="listanh" name="listanh">
        </div>
		<div style="margin-bottom: 15px;">
            <label for="anh" style="font-weight: bold;">Mô Tả (Tùy Chọn):</label>
            <textarea id="mota" name="mota" rows="4" cols="50" style="width: 100%; padding: 10px"></textarea>
        </div>
        <div style="margin-bottom: 15px; display: flex; justify-content: space-between;">
            <button type="submit" style="padding: 10px 20px; border: none; border-radius: 5px; background-color: #007bff; color: #fff; cursor: pointer;">Thêm Sản Phẩm</button>
