			...
			<?php 
				...
				<form action="filter_price.php" method="GET">
					<div class="price-filter">
						...
						<div class="filter">
							<label>
							<input type="radio" name="price_range" value="under_100000"> <span>Dưới 100.000</span>
						</label>
			...
			<div class="card">
				<figure>
				  ...
				  <section class="details">
    				...
    				<a href="./detail.php?id=<?php echo $sp->masp; ?>" class="btn">Xem chi tiết</a>
  				</section>
			</div>
			<?php } ?>
		</div>
