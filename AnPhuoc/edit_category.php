...
if (isset($_GET['maloai'])) {
  $maloai = $_GET['maloai'];
    ...
    echo '<form action="' . htmlspecialchars($_SERVER["PHP_SELF"]) . '?maloai=' . $maloai . '" method="post" style="max-width: 600px; margin: 0 auto; padding: 20px;">';
    echo '<h1 class="text-center py-3">Sửa Thông Tin Loại</h1>';

    echo '<div style="margin-bottom: 15px;">';
    echo '<label for="tenloai" style="font-weight: bold;">Tên loại: </label>';
    echo '<input type="text" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" id="tenloai" name="tenloai" value="' . $product_type['tenloai'] . '" required>';
    echo '</div>';
    ...
    echo '<a href="product_type.php" style="text-decoration: none;"><button type="button" style="padding: 10px 20px; border: none; border-radius: 5px; background-color: #343a40; color: #fff; cursor: pointer;">Quay Lại</button></a>';
    echo '</div>';
    echo '</form>';
}
